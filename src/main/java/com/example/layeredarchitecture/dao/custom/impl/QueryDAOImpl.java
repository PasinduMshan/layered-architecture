...
public class QueryDAOImpl implements QueryDAO {
    ...
    public ArrayList<QueryDTO> getDetailsOnSearchByDate(LocalDate date) throws SQLException, ClassNotFoundException {
        ResultSet rst = SQLUtil.execute("SELECT c.id,c.name,c.address,o.oid,o.date,i.description,od.qty,od.unitPrice FROM OrderDetails od LEFT JOIN Item i ON od.itemCode = i.code LEFT JOIN Orders o ON od.oid = o.oid LEFT JOIN Customer c ON o.customerID = c.id WHERE o.date = ?", date);
